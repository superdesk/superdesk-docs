...
![](./images/image240.png) Personal Space is an icon located on the Workspace Panel. Your Personal Space can also be accessed from the Hamburger menu.
...
![](./images/image241.png) This is the Comments button in the Editor Sidebar.
