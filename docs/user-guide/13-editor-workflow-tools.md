...
![](./images/image245.png) Personal Space is an icon located on the Workspace Panel. Your Personal Space can also be accessed from the Hamburger menu.
...
![](./images/image227.png)![](./images/image228.png)
