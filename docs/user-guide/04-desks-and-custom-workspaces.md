...
![](./images/image37.png) This is the Dashboard icon from the Workspace panel.
...
![](./images/image38.png) This is the Personal Space icon found on the Workspace Panel.
...
![](./images/image39.png) This is an Action menu icon.
...
![](./images/image41.png) This is the Spike tab in the Workspace Panel.
...
![](./images/image42.png) You will find the *Send To* icon in the top right corner of items that are open for editing.
...
![](./images/image44.png) This is the Open Items icon.
