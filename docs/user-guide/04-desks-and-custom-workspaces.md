...
![](./images/image269.png) This is the Dashboard icon from the Workspace panel.
...
![](./images/image174.png) This is the Personal Space icon found on the Workspace Panel.
...
![](./images/image90.png) This is an Action menu icon.
...
![](./images/image295.png) This is the Spike tab in the Workspace Panel.
...
![](./images/image168.png) You will find the *Send To* icon in the top right corner of items that are open for editing.
...
![](./images/image337.png) This is the Open Items icon.
