...
![](./images/image111.png)This is the Create icon.
...
![](./images/image116.png)/![](./images/image117.png)etc. These buttons will make highlighted text into a heading.
![](./images/image118.png)This button places all the text on the current line into a special formatting for quotes.
![](./images/image119.png) This button adds a bulleted list formatting to your cursor location or highlighted text.
![](./images/image120.png) This button adds a numbered list formatting to your cursor location or highlighted text.
![](./images/image121.png) If you are pasting text from another source, and you want to preserve the formatting from the original source, select this button to keep the formatting from the original source.
![](./images/image122.png) This button will make highlighted text **bold**.
![](./images/image123.png)  This button will make highlighted text *italic*.
![](./images/image124.png) This button will make highlighted text underlined.
![](./images/image125.png) This button will make the highlighted text ~~strikethrough~~.
![](./images/image126.png) This button will add a superscript to the highlighted text, for example: 4**2** \= 16
![](./images/image127.png) This button will add a subscript to the highlighted text, for example: H**2**O
![](./images/image128.png)This button allows you to add a website link or link an attachment.
![](./images/image129.png) This button allows you to add an embed. Enter a URL or code to embed.
![](./images/image130.png)This button allows you to add media into the body text field. Depending on your Content Profile settings, there might also be fields specifically for feature media.
![](./images/image131.png) This button allows you to add a table. Once the table is inserted, you can add additional rows, columns and formatting. While editing the table, these options are available at the top of the Body Html field.
![](./images/image132.png)To remove formatting from a section of text, highlight the text and click this button.
![](./images/image133.png) This button allows you to add [Comments](#using-the-inline-comments-feature). If you use the @ symbol, you can notify selected users of your comments. Comments can be viewed using the Editor Sidebar.
![](./images/image134.png) This button allows you to add [Annotations](#using-the-annotations-feature).
![](./images/image135.png) This [Suggestions Mode](#using-the-suggestions-mode) button allows users to collaborate on an article but proposing changes, while leaving the original text intact.
![](./images/image136.png) This button allows you to view formatting, which would otherwise be invisible, for example line breaks, which become highlighted in blue.
...
![](./images/image138.png) When adding text in the Body HTML field, users have the option to toggle the Suggestions Mode using the button displayed above.
...
![](./images/image141.png) The Annotations button may appear in the formatting options at the top of the Body HTML field when editing a news item.
...
![](./images/image148.png) Users can add comments to the body of news articles using the Inline Comments feature in the toolbar at the top of the Body HTML field.
...
**![](./images/image153.png)** This button allows you to add media into the body text field.
...
![](./images/image164.png)This is the ‘*Send To’* button.
...
![](./images/image169.png) Minimise icon.
...
![](./images/image170.png) This is the *Send to* button.
...
![](./images/image171.png) This is the Editor Sidebar.
