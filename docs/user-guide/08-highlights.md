...
![](./images/image95.png)This is the Action Menu.
...
![](./images/image100.png) Export \- Download the news item to a Superdesk-external location.
![](./images/image101.png) Multiedit \- Select items to open side-by-side for simultaneous editing.
![](./images/image102.png) Spike \- Remove the selected item from the desk workflow.
![](./images/image103.png) Send to \- Move the news item from its current stage to another desk or stage.
![](./images/image104.png) Publish \- Publish this item
![](./images/image105.png) Create Package \- Combine the selected items into a new package.
![](./images/image106.png) Highlight Item \- Add the selected item to a different Highlight.
![](./images/image107.png) Mark for User \- The user will receive a notification to follow up on the selected item.
![](./images/image108.png) Duplicate \- Make a copy in the same location, or a different location.
